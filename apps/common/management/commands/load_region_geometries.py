...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for region_json in regions_data:
            ...
            if not region:
                self.stderr.write(self.style.WARNING(f'Region not found: {country_code}'))
                skipped += 1
                continue
        ...
        self.stdout.write(self.style.SUCCESS(f'Update complete: {updated} regions updated, {skipped} skipped. {polygon_count} polygons converted to MultiPolygon.'))
