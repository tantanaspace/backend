...
class GlobalSettingsAdmin(admin.ModelAdmin):
    list_display = ("id", "backoffice_url")
...
class CompanyProfileAdmin(TabbedTranslationAdmin, admin.ModelAdmin):
    list_display = ("id", "support_email", "support_phone_number", "web_site_link")

    fieldsets = (
        (
            _("Social Media Links"),
            {"fields": ("instagram_link", "telegram_link", "web_site_link")},
        ),
        (
...
class UserVenueFavouriteAdmin(admin.ModelAdmin):
    ...
    fieldsets = ((None, {"fields": ("user", "venue")}),)
...
class UserSearchHistoryAdmin(admin.ModelAdmin):
    ...
    fieldsets = ((None, {"fields": ("user", "text")}),)
...
class FacilityAdmin(TabbedTranslationAdmin, admin.ModelAdmin):
    ...
    fieldsets = ((None, {"fields": ("title", "icon", "quick_access")}),)
...
class OTPLogAdmin(admin.ModelAdmin):
    ...
    search_fields = ("phone_number", "message_id", "text")

    readonly_fields = ("created_at", "updated_at", "message_id")

    ordering = ("-created_at",)
    list_per_page = 50

    fieldsets = (
        (_("Basic Information"), {"fields": ("message_id", "phone_number", "text")}),
        (
            _("SMS Status"),
            {
                "fields": (
        ...
        (
            _("Logs"),
            {"fields": ("response_log", "callback_log"), "classes": ("collapse",)},
        ),
        (
            _("Timestamps"),
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
