...
class AnorbankInterface:
    ...
    def __init__(
        self,
        base_url: str = "https://ob-api.anorbank.uz/services/",
        username: str = None,
        password: str = None,
    ):
        if username is None:
    ...
    def _update_token_data(self, response_data: Dict[str, Any]) -> bool:
        ...
        if (
            ...
            and "access_token" in response_data["result"]
            and "refresh_token" in response_data["result"]
            and "expires_in" in response_data["result"]
            and "refresh_expires_in" in response_data["result"]
        ):
    ...
    def _make_request(
        self, method: str, url: str, is_auth_request: bool = False, **kwargs
    ) -> Dict[str, Any]:
        """
    ...
    def _json_rpc_request(
        self, method: str, params: Dict[str, Any], url: str = None
    ) -> Dict[str, Any]:
    ...
    def account_to_card_transfer(
        ...
        """
        from_data = {"account": from_account, "mfo": from_mfo, "name": from_name}
        ...
        return self._json_rpc_request(
            "account.to.card.transfer", {"request": request_data}
        )
    ...
    def account_to_account_transfer(
        ...
        from_purpose_id: str = None,
        from_name: str = None,
        to_comment: str = None,
        to_purpose_id: str = None,
        to_name: str = None,
    ) -> Dict[str, Any]:
        """
        ...
        :return: Result of the operation
        """
        from_data = {"account": from_account, "mfo": from_mfo}
        ...
        to_data = {"account": to_account, "mfo": to_mfo}
        ...
        return self._json_rpc_request(
            "account.to.account.transfer", {"request": request_data}
        )

    def trans_pay_purpose_check(
        self,
        recipient_id: int,
        account: str,
        amount: int,
        ...
        return self._json_rpc_request(
            "trans.pay.purpose.check", {"request": request_data}
        )

    def trans_pay_purpose(
        self, bill_id: int, amount: int, type_: str = "AGENT", otp: str = None
    ) -> Dict[str, Any]:
        """
        Payment
    ...
    def trans_reverse(
        self, bill_id: int, agent_tran_id: str, tran_id: int = None
    ) -> Dict[str, Any]:
        """
        Cancel payment
        ...
        :return: Result of the operation
        """
        request_data = {"billId": bill_id, "agentTranId": agent_tran_id}
    ...
    def cards_new_otp(self, pan: str, expiry: str) -> Dict[str, Any]:
        ...
        :return: Result of the operation
        """
        request_data = {"pan": pan, "expiry": expiry}

        return self._json_rpc_request(
            "cards.new.otp", {"request": request_data}, self.card_url
        )
    ...
    def cards_new_verify(self, id_: str, otp: str) -> Dict[str, Any]:
        ...
        :return: Result of the operation
        """
        request_data = {"id": id_, "otp": otp}

        return self._json_rpc_request(
            "cards.new.verify", {"request": request_data}, self.card_url
        )
    ...
    def account_history(
        ...
        """
        account_data = {"number": number, "mfo": mfo, "currency": currency}

        filter_data = {"from": from_date, "to": to_date, "type": type_}

        params = {"account": account_data, "filter": filter_data}

        return self._json_rpc_request("account.history", params, self.service_url)

    def nci_transaction_status_get(
        self, trans_id: str, group_id: str
    ) -> Dict[str, Any]:
        """
        ...
        """
        request_data = {"transId": trans_id, "groupId": group_id}

        return self._json_rpc_request(
            "nci.transactionStatus.get", {"request": request_data}, self.service_url
        )
