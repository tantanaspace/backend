...
class IikoCloudAPI:
    ...
    def __init__(
        self,
        api_login: str = "bbc6101b17a04c42b5bcc5ef14d1a145",
    ...
    def get_token(self) -> str:
        ...
        if (
            ...
            and datetime.datetime.utcnow() < self.token_expiry
        ):
            return self.token
    ...
    def get_terminal_groups(self, org_id: Optional[str] = None) -> List[Dict[str, Any]]:
        ...
        return self._post("/api/1/terminal_groups", {"organizationIds": [org_id]})

    # ------------------------
    # Работа со столами и зонами
    # ------------------------
    def get_restaurant_sections(
        self, terminal_group_id: str, return_schema: bool = True, revision: int = 0
    ) -> Dict[str, Any]:
        """
    ...
    def get_tables(self, org_id: Optional[str] = None) -> List[IikoTable]:
        ...
        response = self._post("/api/1/reserve/tables", {"organizationIds": [org_id]})
    ...
    def get_available_tables(
        ...
        """
        return self._post(
            "/api/1/reserve/available_tables",
            {
    ...
    def get_reservations(
        self, org_id: str, from_date: datetime.datetime, to_date: datetime.datetime
    ) -> List[IikoReservation]:
        """Получение списка бронирований за период"""
        response = self._post(
            "/api/1/reserve/reserves",
            {
    ...
    def update_reservation(
        self, org_id: str, reserve_id: str, update_data: Dict[str, Any]
    ) -> Dict[str, Any]:
        """Обновление информации о бронировании"""
        payload = {"organizationId": org_id, "id": reserve_id, **update_data}
    ...
    def create_order(
        ...
        payload = {
            "organizationId": org_id,
            "terminalGroupId": terminal_group_id,
            "order": {"tableIds": table_ids, "items": items},
        }
    ...
    def get_order_by_id(self, org_id: str, order_id: str) -> Dict[str, Any]:
        ...
        return self._post(
            "/api/1/order/by_id", {"organizationIds": [org_id], "orderIds": [order_id]}
        )

    def get_orders_by_table(
        self, org_id: str, table_ids: List[str], statuses: Optional[List[str]] = None
    ) -> Dict[str, Any]:
        """Получение заказов по номерам столов"""
        payload = {"organizationIds": [org_id], "tableIds": table_ids}
    ...
    def close_order(self, org_id: str, order_id: str) -> Dict[str, Any]:
        ...
        return self._post(
            "/api/1/order/close", {"organizationId": org_id, "orderId": order_id}
        )

    def change_order_payments(
        self, org_id: str, order_id: str, payments: List[Dict]
    ) -> Dict[str, Any]:
        """Изменение способов оплаты в заказе"""
        return self._post(
            "/api/1/order/change_payments",
            {"organizationId": org_id, "orderId": order_id, "payments": payments},
        )

    def init_order_by_table(
        self, org_id: str, terminal_group_id: str, table_ids: List[str]
    ) -> Dict[str, Any]:
        """
    ...
    def get_payment_types(self, org_id: str) -> List[Dict[str, Any]]:
        ...
        return self._post("/api/1/payment_types", {"organizationIds": [org_id]})

    def get_discounts(self, org_id: str) -> List[Dict[str, Any]]:
        """Получение скидок RMS"""
        return self._post("/api/1/discounts", {"organizationIds": [org_id]})

    def get_stop_lists(self, org_id: str) -> Dict[str, Any]:
        """Получение стоп-листов"""
        return self._post("/api/1/stop_lists", {"organizationIds": [org_id]})
    ...
    def get_command_status(self, org_id: str, correlation_id: str) -> Dict[str, Any]:
        ...
        return self._post(
            ...
            {"organizationId": org_id, "correlationId": correlation_id},
        )
    ...
    def find_table_by_number(
        self, table_number: str, org_id: Optional[str] = None
    ) -> Optional[IikoTable]:
    ...
    def get_available_tables_for_period(
        ...
        return self.get_available_tables(
            terminal_group_id, start_time, duration_minutes, guests_count
        )
