...
class Company(AbstractTimeStampedModel):
    ...
    logo = VersatileImageField(_("Logo"), upload_to="companies/logos/")

    external_id = models.CharField(
        _("External ID"), max_length=255, blank=True, null=True
    )
    parsing_id = models.CharField(
        _("Parsing ID"),
        max_length=500,
        blank=True,
        null=True,
        help_text=_("ID from parsing system"),
    )
...
class VenueCategory(AbstractTimeStampedModel):
    ...
    category_type = models.CharField(
        ...
        default=CategoryType.VENUE_TYPE,
    )
    title = models.CharField(_("Title"), max_length=255)
    icon = VersatileImageField(
        _("Icon"), upload_to="venue/categories/", blank=True, null=True
    )
...
class Venue(AbstractTimeStampedModel):
    company = models.ForeignKey(
        "venues.Company", on_delete=models.CASCADE, verbose_name=_("Company")
    )
    name = models.CharField(_("Name"), max_length=255)
    ...
    facilities = models.ManyToManyField(
        "common.Facility", blank=True, verbose_name=_("Facilities")
    )
    ...
    iiko_api_token = models.CharField(
        _("IIKO API Token"), max_length=255, blank=True, null=True
    )
...
class VenueZone(AbstractTimeStampedModel):
    name = models.CharField(_("Name"), max_length=255)
    photo_view = VersatileImageField(_("Photo View"), upload_to="venue/zones/")
    venue = models.ForeignKey(
        "venues.Venue", on_delete=models.CASCADE, verbose_name=_("Venue")
    )
...
class VenueImage(AbstractTimeStampedModel):
    ...
    image = VersatileImageField(_("Image"), upload_to="venue/images/")
...
class VenueSocialMedia(AbstractTimeStampedModel):
    ...
    social_type = models.CharField(
        _("Social Type"), max_length=50, choices=SocialType.choices
    )
